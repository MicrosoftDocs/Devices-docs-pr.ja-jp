...
##  <a name="central-update-management-in-commercial-environments"></a>商用環境での一元的な更新管理
...
###  <a name="manage-updates-with-configuration-manager-and-intune"></a>Configuration Manager と Intune を使用して更新プログラムを管理する
...
###  <a name="manage-updates-with-microsoft-deployment-toolkit"></a>Microsoft 展開ツールキットを使用して更新プログラムを管理する
...
##  <a name="managing-firmware-with-dfci"></a>DFCI でのファームウェアの管理
...
##  <a name="best-practices-for-update-deployment-processes"></a>更新プログラムの展開プロセスのためのベストプラクティス
...
##  <a name="downloadable-surface-update-packages"></a>ダウンロード可能な Surface 更新パッケージ
...
###  <a name="downloading-.msi-files"></a>.Msi ファイルのダウンロード
...
###  <a name="surface-.msi-naming-convention"></a>Surface の名前付け規則
...
###  <a name="legacy-surface-.msi-naming-convention"></a>以前の Surface の名前付け規則

...
---
# Microsoft Endpoint Configuration Manager を使用して SEMM でデバイスを管理する
...
特定のデバイスの名前と Id の設定は、ConfigureSEMM スクリプトで表示できます <device name> 。 たとえば、Surface Pro X の名前と Id の設定は、ConfigureSEMM と ProX.ps1 のスクリプトに含まれています。

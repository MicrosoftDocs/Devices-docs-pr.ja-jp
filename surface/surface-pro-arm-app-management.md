...
##  <a name="deploying-surface-pro-x"></a>Surface Pro X の展開
...
##  <a name="image-based-deployment-considerations"></a>イメージ ベースの展開に関する考慮事項
...
##  <a name="managing-surface-pro-x-devices"></a>Surface Pro X デバイスの管理
...
###  <a name="third-party-mdm-solutions"></a>サード パーティの MDM ソリューション
...
##  <a name="servicing-surface-pro-x"></a>Surface Pro X のメンテナンス
...
###  <a name="recommendations-for-commercial-customers"></a>商用利用のお客様向けの推奨事項
...
##  <a name="running-apps-on-surface-pro-x"></a>Surface Pro X でのアプリの実行
...
##  <a name="virtual-desktops-(vdi)"></a>仮想デスクトップ (VDI)
...
##  <a name="browsing-with-surface-pro-x"></a>Surface Pro X で使用できるブラウザー
...
##  <a name="installing-and-using-microsoft-office"></a>Microsoft Office のインストールと使用
...
###  <a name="can-i-deploy-surface-pro-x-with-mdt-or-endpoint-configuration-manager"></a>MDT または Endpoint Configuration Manager を使用して Surface Pro X を展開できますか?
...
###  <a name="how-can-i-deploy-surface-pro-x"></a>Surface Pro X を展開する方法は?

Surface Pro X は Windows Autopilot を使用して展開できます。

###  <a name="is-a-bmr-available"></a>BMR は利用できますか?

はい、「[Surface の回復イメージのダウンロード](https://support.microsoft.com/surfacerecoveryimage)」を参照してください。

###  <a name="is-intune-required-to-manage-surface-pro-x"></a>Surface Pro X を管理するためには Intune が必要ですか?

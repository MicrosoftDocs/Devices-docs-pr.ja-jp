...
| 3.5 mm Audio in/out                 | Yes                                                         | あり                                                                                                 | Yes              |
...
| Wake-on-LAN from S4/S5 sleep modes  | No                                                          | あり                                                                                                 |          Yes        |
| Network PXE boot                    | Yes                                                         | あり                                                                                                 |        Yes          |
| SEMM host access control            | No                                                          | あり                                                                                                 | No               |
| SEMM port access control<sup>2</sup>          | No                                                          | あり                                                                                                 | No               |

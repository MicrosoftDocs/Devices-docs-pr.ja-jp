...
## Surface Ethernet アダプターおよび Configuration Manager の展開
...
## Configuration Manager を使用した Surface アプリの展開
...
## ステージングメディアを Surface クライアントと共に使用する

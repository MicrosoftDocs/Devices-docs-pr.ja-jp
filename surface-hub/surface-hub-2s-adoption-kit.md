---
title: Surface Hub 2S の導入とトレーニングガイド
description: Microsoft は、Surface Hub 2S の導入を支援するために、ユーザーが利用できるようにするためのダウンロード可能な教材を開発しました。
keywords: コンマで値を区切る
ms.prod: surface-hub
ms.sitesec: library
author: greg-lindsay
...
ms.locfileid: "10835773"
---
# Surface Hub 2S の導入とトレーニングガイド
...
- [トレーニングガイド–ヘルプデスク](downloads/TrainingGuide-SurfaceHub2S-HelpDesk.pdf)
- [トレーニングガイド– Microsoft Teams のデスクトップ](downloads/Guide-SurfaceHub2S-Teams.pptx)
...
- [Surface Hub 上の Microsoft ホワイトボードの概要](downloads/Guide-SurfaceHub2S-Whiteboard.pptx)
- [Surface Hub 上の Microsoft Teams の概要](downloads/Guide-SurfaceHub2S-Teams.pptx)
...
- [Teams 会議を管理する](downloads/QRCManageTeamsMeeting.pdf)
- [ナビゲーションの基本](downloads/QRCNavigationBasics.pdf)
- [Teams 会議のスケジュールを設定する](downloads/QRCScheduleTeamsMeeting.pdf)
- [新しい Teams 会議を開始する](downloads/QRCStartNewTeamsMeeting.pdf)
- [ファイルを共有または送信する](downloads/QRCShareSendFile.pdf)
- [サインインして会議やファイルを表示する](downloads/QRCSignInToViewMeetingsFiles.pdf)
- [ホワイトボードの詳細](downloads/QRCWhiteboardAdvanced.pdf)
- [ホワイトボードツール](downloads/QRCWhiteboardTools.pdf)

[すべてのクイックリファレンスカードをダウンロードする](https://download.microsoft.com/download/E/7/F/E7FC6611-BB55-43E1-AF36-7BD5CE6E0FE0/SurfaceHub2S-EndUserGuides-July2019.zip)

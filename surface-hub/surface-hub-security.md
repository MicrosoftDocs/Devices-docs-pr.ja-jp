...
ms.locfileid: "10835197"
---
# Surface Hub のセキュリティ概要

Surface Hub には、Windows 10 Team エディション オペレーティング システムを実行している、カスタム プラットフォーム ファームウェアを含むロックダウン コンピューティング アプライアンスが備わっています。 これによりデバイスは、従来の "単一使用" セキュア キオスクの "必要なものだけを実行する" 戦略を採用し、それに基づいて先進のセキュリティを実現できます。 Surface Hub は、多様なコラボレーション ユーザー エクスペリエンスに対応するように構築されていて、常に進化しているセキュリティの脅威から保護されています。
...
## Windows 10 のエンタープライズ レベルのセキュリティ
